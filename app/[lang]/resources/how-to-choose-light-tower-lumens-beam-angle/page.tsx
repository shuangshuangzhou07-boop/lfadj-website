      ...
      <main className="overflow-x-clip bg-white text-slate-950">
        ...
        <section className="bg-slate-950 px-4 py-14 text-white sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="mt-14 flex flex-col gap-6 rounded-xl bg-white p-6 text-slate-950 sm:p-8 lg:flex-row lg:items-center lg:justify-between"><div className="max-w-3xl"><h2 className="text-2xl font-bold sm:text-3xl">{copy.ctaTitle}</h2><p className="mt-3 leading-7 text-slate-600">{copy.ctaText}</p></div><div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap"><Link href={`/${lang}/contact`} className="inline-flex min-h-12 shrink-0 items-center justify-center rounded-md bg-amber-500 px-6 text-center font-semibold hover:bg-amber-400">{copy.ctaLabel}</Link><Link href={`/${lang}/products`} className="inline-flex min-h-12 shrink-0 items-center justify-center rounded-md border border-slate-300 bg-white px-6 text-center font-semibold hover:border-slate-500 hover:bg-slate-100">{copy.ctaSecondaryLabel}</Link></div></div>
          </div>
        </section>
      </main>
    </>
