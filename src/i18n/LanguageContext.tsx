...
const pathMap: Record<string, { en: string; zh: string }> = {
  ...
  "/en/applications": { en: "/en/applications", zh: "/zh/applications" },
  "/en/solutions": { en: "/en/solutions", zh: "/zh/solutions" },
  ...
  "/en/contact": { en: "/en/contact", zh: "/zh/contact" },
  "/zh": { en: "/en", zh: "/zh" },
  ...
  "/zh/applications": { en: "/en/applications", zh: "/zh/applications" },
  "/zh/solutions": { en: "/en/solutions", zh: "/zh/solutions" },
  "/zh/oem制造": { en: "/en/oem", zh: "/zh/oem制造" },
  "/zh/案例": { en: "/en/case-studies", zh: "/zh/案例" },
  "/zh/常见问题": { en: "/en/faq", zh: "/zh/常见问题" },
  "/zh/博客": { en: "/en/blog", zh: "/zh/博客" },
  "/zh/contact": { en: "/en/contact", zh: "/zh/contact" },
};
