...
export function generateMetadata({ params }: { params: { category: string } }) { return getPlaceholderMetadata("zh", "products", params.category); }
export default function Page({ params }: { params: { category: string } }) {
  const copy = getPlaceholderCopy("zh", "products", params.category);
  if (!copy) notFound();
