...
export function generateMetadata({ params }: { params: { solution: string } }) { return getPlaceholderMetadata("en", "solutions", params.solution); }
export default function Page({ params }: { params: { solution: string } }) {
  const copy = getPlaceholderCopy("en", "solutions", params.solution);
  if (!copy) notFound();
